        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="relative py-20 lg:py-32 overflow-hidden bg-slate-900 text-white">
                ...
                <div className="container relative z-10 px-4 md:px-6 mx-auto text-center">
                    ...
                    <p className="text-xl text-slate-300 max-w-2xl mx-auto mb-10">
                        Wallonie, Bruxelles, Flandre : Calculez votre rentabilité selon votre région.
                    </p>
            ...
            <section id="comment-ca-marche" className="py-20 bg-white">
                <div className="container px-4 md:px-6 mx-auto">
                    <h2 className="text-3xl font-bold text-center mb-16 text-slate-900">Pourquoi utiliser Solar-Estim Belgique ?</h2>
                ...
                <div className="container px-4 md:px-6 mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            {
                                title: "Rentabilité : Mythe ou Réalité ?",
                                category: "Guide",
